...
class TestNotificationChannelRequest(BaseModel):
    ...
    mask_token: str = "******"
    title: str = Field(default="Finance Analysis 通知测试", min_length=1, max_length=80)
    content: str = Field(default="这是一条来自 Finance Analysis 设置页的通知测试消息。", min_length=1, max_length=1000)
