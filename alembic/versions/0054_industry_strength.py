...
def upgrade():
    op.create_table(
        ...
        sa.Column("daily_valid_count", sa.Integer()),
        sa.Column("ma5_valid_count", sa.Integer()),
        sa.Column("above_ma5_count", sa.Integer()),
        sa.Column("ma20_valid_count", sa.Integer()),
        sa.Column("above_ma20_count", sa.Integer()),
