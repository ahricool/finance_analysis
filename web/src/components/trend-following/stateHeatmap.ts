...
export const STATE_COLORS: Record<TrendState, { light: string; dark: string }> = {
  ...
  ENTRY: { light: '#4ade80', dark: '#4ade80' },
  PYRAMIDING: { light: '#15803d', dark: '#15803d' },
  HOLDING: { light: '#22a565', dark: '#22a565' },
  WEAKENING: { light: '#facc15', dark: '#eab308' },
  REDUCE: { light: '#fb923c', dark: '#f97316' },
  EXIT: { light: '#ef4444', dark: '#f87171' },
};
