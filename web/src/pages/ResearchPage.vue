...
type ResearchTab = 'market-sentiment' | 'industry-strength' | 'macro' | 'quant' | 'etf-rotation' | 'trend-following' | 'crypto-btc';
...
<template>
  <div class="space-y-6 py-4 sm:py-6">
    <PageHeader
      title="研究"
      description="研究量化模型、ETF 动量轮动、趋势跟踪、行业强度、市场情绪、宏观环境与 BTC 策略。"
    />
    <ModuleTabs
