    ...
    extend: {
      colors: {
        ...
        purple: {
          ...
          dim: 'hsl(var(--accent-secondary) / 0.8)',
          glow: 'hsl(var(--accent-secondary) / 0.22)',
        },
        success: {
      ...
      backgroundImage: {
        'gradient-purple-cyan': 'linear-gradient(135deg, hsl(var(--primary) / 0.14) 0%, hsl(var(--accent-secondary) / 0.08) 100%)',
        'gradient-card-border': 'linear-gradient(135deg, hsl(var(--primary) / 0.34) 0%, hsl(var(--accent-secondary) / 0.2) 55%, hsl(var(--border) / 0.5) 100%)',
        'gradient-cyan': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.84) 100%)',
        'primary-gradient': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.84) 100%)',
      },
      boxShadow: {
        'soft-card': 'var(--shadow-soft-card)',
        'soft-card-strong': 'var(--shadow-soft-card-strong)',
        'glow-cyan': '0 10px 24px hsl(var(--primary) / 0.22)',
        'glow-purple': '0 10px 24px hsl(var(--accent-secondary) / 0.16)',
        'glow-success': '0 0 20px rgba(0, 255, 136, 0.3)',
        'glow-danger': '0 0 20px rgba(255, 68, 102, 0.3)',
        'cyan/20': '0 8px 20px hsl(var(--primary) / 0.16)',
        'cyan/22': '0 12px 26px hsl(var(--primary) / 0.2)',
      },
      borderRadius: {
        lg: 'var(--radius)',
