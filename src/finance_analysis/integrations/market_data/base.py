...
import pandas as pd
import numpy as np
from finance_analysis.stocks.reference_data.loader import get_index_stock_name
...
class DataFetcherManager:
    ...
    def _get_tickflow_fetcher(self):
        ...
        with self._tickflow_lock:
            ...
            try:
                from finance_analysis.integrations.market_data.providers.tickflow import TickFlowFetcher
    ...
    def get_realtime_quote(self, stock_code: str, *, log_final_failure: bool = True):
        ...
        from finance_analysis.integrations.market_data.providers.akshare import _is_us_code
