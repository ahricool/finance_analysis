...
from finance_analysis.agent.tools.registry import ToolParameter, ToolDefinition
...
def _handle_analyze_trend(stock_code: str) -> dict:
    ...
    from finance_analysis.analysis.technical.analyzer import StockTrendAnalyzer
