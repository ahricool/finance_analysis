...
ZCARD ZSCAN SMEMBERS SCARD SSCAN SCAN TYPE EXISTS TTL PTTL XLEN XRANGE XREVRANGE INFO
PING STRLEN GETRANGE HEXISTS HKEYS HVALS SISMEMBER SMISMEMBER
ZSCORE ZMSCORE ZRANK ZREVRANK ZCOUNT ZLEXCOUNT XINFO DBSIZE TIME OBJECT""".split())
