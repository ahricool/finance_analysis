...
from finance_analysis.database.models import StockDaily
...
class StockRepository:
    ...
    def get_range(
        ...
        try:
            ...
            logger.exception(f"获取日期范围数据失败: {e}")
            return []
    ...
    def get_analysis_context(
        ...
        try:
            ...
            logger.exception(f"获取分析上下文失败: {e}")
            return None
