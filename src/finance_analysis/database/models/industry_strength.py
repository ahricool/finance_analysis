...
class IndustryStrengthSnapshot(Base):
    ...
    daily_valid_count = Column(Integer)
    ma5_valid_count = Column(Integer)
    above_ma5_count = Column(Integer)
    ma20_valid_count = Column(Integer)
    above_ma20_count = Column(Integer)
