...
from finance_analysis.integrations.market_data.base import canonical_stock_code
...
class AskCommand(BotCommand):
    ...
    def _load_skills() -> List[object]:
        try:
            from finance_analysis.agent.factory import get_skill_manager
    ...
    def _get_default_skill_id(cls) -> str:
        try:
            from finance_analysis.agent.skills.defaults import get_primary_default_skill_id
    ...
    def _analyze_multi(
        ...
        def _run_one(stock_code: str) -> Tuple[str, Optional[Dict[str, Any]], Optional[str]]:
            try:
                from finance_analysis.agent.conversation import conversation_manager
                from finance_analysis.agent.factory import build_agent_executor
