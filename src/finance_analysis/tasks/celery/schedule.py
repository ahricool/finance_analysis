...
_DEFINITIONS: List[ScheduledTaskDefinition] = [
    ...
    ScheduledTaskDefinition(
        ...
        schedules=[
            CronSchedule(minute="46", hour="9", day_of_week="mon-fri", timezone=US_TIMEZONE),
            CronSchedule(minute="1,16,31,46", hour="10-15", day_of_week="mon-fri", timezone=US_TIMEZONE),
        ],
        schedule_text="美股交易日 09:46-15:46 America/New_York，每15分钟",
    ...
    ScheduledTaskDefinition(
        ...
        schedule_text="A股交易日 09:45-11:30、13:15-15:00，每15分钟",
        timezone=SCHEDULE_TIMEZONE,
        queue=QUEUE_ALERTS,
        expires=EXPIRES_INTRADAY,
    ),
