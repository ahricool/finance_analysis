"""Celery entry point for A-share intraday analysis."""
...
DEFINITION = require_scheduled_task_definition(JOB_A_SHARE_INTRADAY_ANALYSIS)
...
__all__ = ["analysis_a_share_intraday"]
