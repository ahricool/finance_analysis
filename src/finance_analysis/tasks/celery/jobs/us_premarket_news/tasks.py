"""Celery entry point for US premarket news intelligence."""
...
from .service import USPremarketNewsTaskService
...
def analysis_us_premarket_news(scheduler_job_id: Optional[str] = None, **_: Any) -> dict[str, Any]:
    return USPremarketNewsTaskService().run()


__all__ = ["analysis_us_premarket_news"]
