"""Celery entry point for US premarket analysis."""
...
from .service import USPremarketAnalysisTaskService
...
def analysis_us_premarket(scheduler_job_id: Optional[str] = None, **_: Any) -> dict[str, Any]:
    return USPremarketAnalysisTaskService().run()


__all__ = ["analysis_us_premarket"]
