...
SCHEDULED_TASK_DEFINITIONS = (
    ...
    ScheduledTaskDefinition(
        ...
        schedule_text="周一至周五 20:00 增量；每月第一个周日 10:00 全量（America/New_York）",
        timezone=US_TIMEZONE,
        queue=QUEUE_INGESTION,
        expires=EXPIRES_MARKET_DATA_SYNC,
        allow_manual_run=True,
    ...
    ScheduledTaskDefinition(
        ...
        schedules=(CronSchedule(minute="0", hour="21", day_of_week="mon-fri", timezone=US_TIMEZONE),),
        schedule_text="周一至周五 21:00 America/New_York",
        timezone=US_TIMEZONE,
        queue=QUEUE_ANALYSIS,
        expires=EXPIRES_ETF_ROTATION,
        allow_manual_run=True,
    ...
    ScheduledTaskDefinition(
        ...
        schedules=(CronSchedule(minute="30", hour="19", day_of_week="mon-fri"),),
    ...
    ScheduledTaskDefinition(
        ...
        schedules=(CronSchedule(minute="0", hour="22", day_of_week="mon-fri", timezone=US_TIMEZONE),),
        schedule_text="周一至周五 22:00 America/New_York",
        timezone=US_TIMEZONE,
        queue=QUEUE_ANALYSIS,
        expires=EXPIRES_TREND_FOLLOWING,
        allow_manual_run=True,
