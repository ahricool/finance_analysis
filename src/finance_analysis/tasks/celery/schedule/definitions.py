...
SCHEDULED_TASK_DEFINITIONS = (
    ...
    ScheduledTaskDefinition(
        ...
        description="每 5 分钟读取已连接的 Google Sheet 持仓快照，作为 DB 持仓的补充来源",
    ...
    ScheduledTaskDefinition(
        ...
        schedules=(
            CronSchedule(minute="*/5", hour="9-11", day_of_week="mon-fri"),
            CronSchedule(minute="*/5", hour="13-14", day_of_week="mon-fri"),
            CronSchedule(minute="0,5", hour="15", day_of_week="mon-fri"),
        ),
        schedule_text="A股交易日 09:30-11:30、13:00-15:05 每5分钟 Asia/Shanghai（午休不运行）",
        timezone=SCHEDULE_TIMEZONE,
        queue=QUEUE_ALERTS,
        expires=EXPIRES_TRADE_ENGINE,
    ),
    ScheduledTaskDefinition(
        ...
        schedules=(
            CronSchedule(minute="*/5", hour="9-16", day_of_week="mon-fri", timezone=US_TIMEZONE),
        ),
        schedule_text="美股交易日 09:30-16:05 America/New_York 每5分钟（自动适配夏令时/半日市）",
        timezone=US_TIMEZONE,
        queue=QUEUE_ALERTS,
        expires=EXPIRES_TRADE_ENGINE,
    ),
