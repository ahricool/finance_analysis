...
SCHEDULED_TASK_DEFINITIONS = (
    ...
    ScheduledTaskDefinition(
        ...
        schedules=(
            CronSchedule(minute="0", hour="10-11", day_of_week="mon-fri"),
            CronSchedule(minute="0", hour="13-14", day_of_week="mon-fri"),
            CronSchedule(minute="30", hour="14", day_of_week="mon-fri"),
        ),
        schedule_text="周一至周五 10:00、11:00、13:00、14:00、14:30 Asia/Shanghai（午休不运行）",
        timezone=SCHEDULE_TIMEZONE,
        queue=QUEUE_ANALYSIS,
    ...
    ScheduledTaskDefinition(
        ...
        schedules=(
            CronSchedule(minute="0", hour="10-15", day_of_week="mon-fri", timezone=US_TIMEZONE),
        ),
        schedule_text="周一至周五 10:00-15:00 America/New_York，每小时（自动适配夏令时）",
        timezone=US_TIMEZONE,
        queue=QUEUE_ANALYSIS,
        expires=EXPIRES_TREND_FOLLOWING_PREVIEW,
        allow_manual_run=True,
