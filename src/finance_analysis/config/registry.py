...
from finance_analysis.notification.noise_control import NOTIFICATION_SEVERITIES
from finance_analysis.notification.routing import ROUTABLE_NOTIFICATION_CHANNELS
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LLM_MODEL": {
        "title": "Primary Model",
        "description": "Primary LiteLLM model id in provider/model format (e.g. openai/gpt-5.5, gemini/gemini-3.1-pro-preview).",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LLM_BASE_URL": {
        "title": "API Base URL",
        "description": "Optional OpenAI-compatible api_base passed to LiteLLM. Leave empty for provider-native endpoints.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LLM_API_KEY": {
        "title": "API Key",
        "description": "API key used for all LiteLLM completion calls.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "LLM_FALLBACK_MODELS": {
        ...
        "description": "Comma-separated fallback models tried when the primary model fails.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LITELLM_CONFIG": {
        "title": "Advanced Model Routing Config (deprecated)",
        "description": "Deprecated. Unified LiteLLM config now uses LLM_MODEL / LLM_BASE_URL / LLM_API_KEY only.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LLM_CHANNELS": {
        "title": "LLM Channels (deprecated)",
        "description": "Deprecated. Channel-based LLM configuration has been removed.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ANSPIRE_LLM_MODEL": {
        ...
        "description": "Default model used when ANSPIRE_API_KEYS enables the Anspire LLM gateway without an explicit LLM_MODEL.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
