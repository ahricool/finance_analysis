# -*- coding: utf-8 -*-
"""Mandatory-field integrity checks and placeholder fills for analysis results."""

from typing import TYPE_CHECKING, Any, List, Tuple

from finance_analysis.reporting.localization import get_placeholder_text
from finance_analysis.analysis.report_text_utils import _normalize_risk_warning_values
