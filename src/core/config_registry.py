...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "LITELLM_MODEL": {
        "title": "Primary Model (legacy alias)",
        "description": "Deprecated alias of LLM_MODEL. Prefer LLM_MODEL for new setups.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "LITELLM_FALLBACK_MODELS": {
        "title": "Fallback Models (legacy alias)",
        "description": "Deprecated alias of LLM_FALLBACK_MODELS.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
