...
class TestFundamentalContext(unittest.TestCase):
    def test_non_cn_market_returns_not_supported(self) -> None:
        ...
        with patch("finance_analysis.config.get_config", return_value=cfg):
    ...
    def test_capital_flow_not_supported_status(self) -> None:
        ...
        with patch("finance_analysis.config.get_config", return_value=cfg), \
                patch(
                    "finance_analysis.integrations.market_data.fundamental_adapter.AkshareFundamentalAdapter.get_cfinance_analysis.interfaces.apital_flow",
                    return_value={
                        "status": "not_supported",
                        "stock_flow": {},
