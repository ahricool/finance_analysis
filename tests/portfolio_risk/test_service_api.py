...
def test_holdings_migration_revision_is_single_head():
    ...
    assert script.get_heads() == ["0057_holdings_published_snapshot"]
    revision = script.get_revision("0057_holdings_published_snapshot")
    assert revision.down_revision == "0056_holdings_portfolio_risk"
...
def test_published_snapshot_migration_on_live_database():  # pragma: allowlist secret
    ...
    path = Path("alembic/versions/0057_holdings_published_snapshot.py")
